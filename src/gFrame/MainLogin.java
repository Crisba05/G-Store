...
public class MainLogin extends javax.swing.JFrame {
    ...
    gclass_sql metodo = new gclass_sql();
    ...
    private void initComponents() {
        ...
        logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gImg/login/logo.png"))); // NOI18N
        getContentPane().add(logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 210, 170, 240));

        icPassView.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gImg/login/passView.png"))); // NOI18N
        ...
        icPass.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gImg/login/pass.png"))); // NOI18N
        ...
        icUser.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gImg/login/user.png"))); // NOI18N
        ...
        bckMain.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gImg/login/bckMain.png"))); // NOI18N
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gImg/login/background.png"))); // NOI18N
    ...
    private void btnLoginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLoginMouseClicked
         buscar = metodo.cargar(txtUser.getText(),txtPass.getText());
